...
const expectedPaths = [
  ...
  "dist/index.js",
  "dist/index.js.map",
  "dist/store/errors.d.ts",
  "dist/store/errors.d.ts.map",
  "dist/store/errors.js",
  "dist/store/errors.js.map",
  "dist/store/index.d.ts",
  "dist/store/index.d.ts.map",
  "dist/store/index.js",
  "dist/store/index.js.map",
  "dist/store/migrations.d.ts",
  "dist/store/migrations.d.ts.map",
  "dist/store/migrations.js",
  "dist/store/migrations.js.map",
  "dist/store/sqlite-job-store.d.ts",
  "dist/store/sqlite-job-store.d.ts.map",
  "dist/store/sqlite-job-store.js",
  "dist/store/sqlite-job-store.js.map",
