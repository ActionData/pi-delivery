...
**Progress:** versioned domain events, lifecycle invariants, and deterministic replay are tracked in [issue #2](https://github.com/ActionData/pi-delivery/issues/2).
